...
- [Describe schema for an LLM](https://iplweb.github.io/djangoql-iplweb/llm-schema/) — emit the search space as JSON or compact text to teach a model to generate DjangoQL
